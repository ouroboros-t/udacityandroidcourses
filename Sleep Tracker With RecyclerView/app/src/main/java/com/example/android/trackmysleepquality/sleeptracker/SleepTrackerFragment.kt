...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //set up so when a night is clicked on, the navigatetoSleepDataquality is set to its id,
        //and navigation occurs to to the sleep details for that night (via its id)
        sleepTrackerViewModel.navigateToSleepDataQuality.observe(viewLifecycleOwner, Observer {
            night -> night?.let{
                this.findNavController().navigate(SleepTrackerFragmentDirections
                    .actionSleepTrackerFragmentToSleepDetailFragment(night))
            //tell program it's done navigating
        ...
        sleepTrackerViewModel.nights.observe(viewLifecycleOwner, Observer {
            //whenever we have a non-null value, we assign it to the adapter data to be shown by recyclerview
            it?.let{
