...
val KEY_DESSERT_TIMER = "key_dessert_timer"
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //each time onCreate is called, set desserts sold to 0
        dessertsSold = 0
        ...
        //create dessertTimer object and pass in MainActivity as the lifecycle to be observed (use "this" keyword)
        dessertTimer = DessertTimer(this.lifecycle)


        //best practice is to check if savedstate is null
